...
`,pt=k(class extends w{constructor(){super(),this.__registerHost(),this.size=void 0,this.align=void 0}static get style(){return ot}},[0,"slate-container",{size:[513],align:[513]}]);function ct(){if(typeof customElements>"u")return;["slate-container"].forEach(n=>{switch(n){case"slate-container":customElements.get(n)||customElements.define(n,pt);break}})}ct();const gt=`@layer slate-components-1 {
  slate-heading {
    /* Normalize */
    display: block;
    box-sizing: border-box;
...
`,ft=k(class extends w{constructor(){super(),this.__registerHost(),this.level="2",this.role="heading",this.size=void 0,this.transform=void 0,this.variant=void 0,this.weight=void 0,this.wrap=void 0}connectedCallback(){this.host.setAttribute("aria-level",this.level)}handleUpdateLevel(n){this.host.setAttribute("aria-level",n)}get host(){return this}static get watchers(){return{level:["handleUpdateLevel"]}}static get style(){return gt}},[0,"slate-heading",{level:[513],role:[513],size:[513],transform:[513],variant:[513],weight:[513],wrap:[516]},void 0,{level:["handleUpdateLevel"]}]);function dt(){if(typeof customElements>"u")return;["slate-heading"].forEach(n=>{switch(n){case"slate-heading":customElements.get(n)||customElements.define(n,ft);break}})}dt();const xt=":host,a{box-sizing:border-box;position:relative;display:inline}a{color:var(--color-brand-700);font-weight:var(--font-weight-bold);text-decoration:inherit}",vt=k(class extends w{constructor(){super(),this.__registerHost(),this.__attachShadow(),this.href=void 0,this.target=void 0,this.rel=void 0}render(){var n;const a=this.target,e=(n=this.rel)!==null&&n!==void 0?n:a==="_blank"?"noreferrer noopener":void 0;return m("a",{part:"host",href:this.href,target:a,rel:e},m("slot",null))}static get style(){return xt}},[1,"slate-link",{href:[513],target:[513],rel:[513]}]);function ut(){if(typeof customElements>"u")return;["slate-link"].forEach(n=>{switch(n){case"slate-link":customElements.get(n)||customElements.define(n,vt);break}})}ut();const ht=`@layer slate-components-1 {
  slate-stack {
    /* Normalize */
    box-sizing: border-box;
    position: relative;
